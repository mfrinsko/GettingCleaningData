...
1. A README.md file to explain the contents of the reposity.  **You are reading this now.**
2. A script that contains all of the commands to download and transform the data into 2 tidy data sets.
3. A codebook that details the 
